...
const List<Map<String, dynamic>> games = [
  {
    "id": 540,
    "title": "Overwatch 2",
...
IconData getIconPlataform(int index) {
  switch (games[index]['platform']) {
    case 'PC (Windows)':
      return Icons.window;
    case 'Web Browser':
...
IconData getIconFromPlataform(String plataforma) {
  switch (plataforma) {
    case 'PC (Windows)':
      return Icons.window;
    case 'Windows':
...
//Pegar somente o ano da data de lançamento (os primeiros 4 caracteres)
String getYearReleaseDate(int index) {
  return games[index]['release_date'].substring(0, 4);
}
