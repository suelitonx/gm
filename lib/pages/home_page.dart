...
import 'package:gamematch/pages/list_chats_page.dart';
...
import 'jogos_curtidos_page.dart';
    ...
    return Drawer(
      ...
      child: ListView(
        children: [
          ...
          //Mensagens
          ListTile(
            title: Text("Mensagens", style: GoogleFonts.nunitoSans(), overflow: TextOverflow.ellipsis),
            leading: const Icon(Icons.chat_rounded),
            onTap: () async {
              Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ListChatsPage()));
            },
          ),
