...
class _ExampleState extends State<Example> {
  ...
  void fetchMoviesFakeApi() {
    ...
    movies = [
      Movie(title: "House of the dragon", genere: ["Action", "Adventure", "Drama"]),
      Movie(title: "She-Hulk: Attorney at Law", genere: ["Action", "Adventure", "Comedy"]),
    ];
  }
                  ...
                  trailing: Stack(
                    children: [
                      AnimatedReactButton(
                        ...
                        defaultColor: movies[index].isFavorite ? Colors.red : Colors.grey,
                        reactColor: !movies[index].isFavorite ? Colors.red : Colors.grey,
                      ),
                      Visibility(
